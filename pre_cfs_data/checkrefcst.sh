...
#SBATCH -e ./log.03.rfcst
#SBATCH -o ./log.03.rfcst
...
for BASE_YEAR in $(seq 1991 2011); do
	    # Default year
    YEAR=$BASE_YEAR
  ...
  YYYYMMDD="${CYCLE:0:8}"
  YEAR="${CYCLE:0:4}"
  URL="${BASE_URL}/${YEAR}/${YYYYMM}/${YYYYMMDD}"
       ...
       for prefx in ocnf flxf;do
		  ...
		  wget $URL/$FILE.grb2
            ...
            echo "FIND $FILE.grib2"
			  ...
			  FILE1=$prefx.$FILE_FCST.grb2
		      rm /scratch4/NCEPDEV/ensemble/Xiaqiong.Zhou/data/cfs/fcst/$FILE1
	              ln -s /scratch4/NCEPDEV/ensemble/Xiaqiong.Zhou/data/cfs/refcst/$FILE.grb2 /scratch4/NCEPDEV/ensemble/Xiaqiong.Zhou/data/cfs/fcst/$FILE1
		      echo linking $FILE
                  fi
