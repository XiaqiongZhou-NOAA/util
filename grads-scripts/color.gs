...
function spcol( kind )
  ...
  while( i <= length )
    ...
    if( c%c2 = '->' | c%c2 = '-(' | c = '>' | c = '(' | c = ')' | i = length )
      ...
      if( coltemp = 'radar'    ) ; coltemp = '(0,255,255)->(0,157,255)->(0,0,255)->(9,130,175)->(0,255,0)->(8,175,20)->(255,214,0)->(255,152,0)->(255,0,0)->(221,0,27)->(188,0,54)->(121,0,109)->(121,51,160)->(195,163,212)->(255,255,255)' ; endif
      if( coltemp = 'amwg'    ) ; coltemp = '(147,112,219)->(0,0,200)->(60,100,230)->(120,155,242)->(176,224,230)->(32,178,170)->(154,205,50)->(46,139,87)->(245,230,190)->(222,184,135)->(255,225,0)->(255,165,0)->(255,69,0)->(178,34,34)->(255,182,193)->(255,20,147)' ; endif
      if( coltemp = 'prcp'    ) ; coltemp = '(255,255,255)->(170,255,255)->(85,160,255)->(29,0,255)->(126,229,91)->(78,204,67)->(46,178,57)->(30,153,61)->(255,255,102)->(255,204,102)->(255,136,76)->(255,25,25)->(204,61,61)->(165,49,49)->(237,0,237)->(137,103,205)->(163,163,163)' ; endif
      if( coltemp = 'step'    ) ; coltemp = '(153,15,15)->(178,44,44)->(204,81,81)->(229,126,126)->(255,178,178)->(153,84,15)->(178,111,44)->(204,142,81)->(229,177,126)->(255,216,178)->(107,153,15)->(133,178,44)->(163,204,81)->(195,229,126)->(229,255,178)->(15,107,153)->(44,133,178)->(81,163,204)->(126,195,229)->(178,229,255)->(38,15,153)->(66,44,178)->(101,81,204)->(143,126,229)->(191,178,255)' ; endif
      if( coltemp = 'red2blue'    ) ; coltemp = '(44,4,94)->(73,1,63)->(133,0,28)->(189,3,23)->(192,49,24)->(202,96,26)->(219,161,32)->(227,194,33)->(233,222,36)->(249,254,41)->(255,255,255)->(255,255,255)->(152,220,31)->(115,195,29)->(81,164,25)->(80,170,40)->(93,201,97)->(111,233,179)->(85,156,246)->(56,73,245)->(36,12,243)->(25,12,243)' ; endif
      if( coltemp = 'blue2red'    ) ; coltemp = '(25,12,243)->(36,12,243)->(56,73,245)->(85,156,246)->(111,233,179)->(93,201,97)->(80,170,40)->(81,164,25)->(115,195,29)->(152,220,31)->(255,255,255)->(255,255,255)->(249,254,41)->(233,222,36)->(227,194,33)->(219,161,32)->(202,96,26)->(192,49,24)->(189,3,23)->(133,0,28)->(73,1,63)->(44,4,94)' ; endif
      if( coltemp ='blue2red1'   ); coltemp ='(0,0,120)->(0,30,110)->(0,60,140)->(0,110,190)->(0,160,240)->(0,180,190)->(0,205,140)->(0,230,90)->(0,255,0)->(250,250,250)->(250,250,250)->(245,245,200)->(240,240,100)->(230,220,50)->(225,200,30)->(215,170,28)->(200,110,25)->(190,60,20)->(185,10,20)->(130,0,30)->(75,5,70)' ; endif



      if( coltemp = 'revstep'    ) ; coltemp = '(191,178,255)->(143,126,229)->(101,81,204)->(66,44,178)->(38,15,153)->(178,229,255)->(126,195,229)->(81,163,204)->(44,133,178)->(15,107,153)->(229,255,178)->(195,229,126)->(163,204,81)->(133,178,44)->(107,153,15)->(255,216,178)->(229,177,126)->(204,142,81)->(178,111,44)->(153,84,15)->(255,178,178)->(229,126,126)->(204,81,81)->(178,44,44)->(153,15,15)' ; endif
      if( coltemp = 'revstep'    ) ; coltemp = '(191,178,255)->(143,126,229)->(101,81,204)->(66,44,178)->(38,15,153)->(178,229,255)->(126,195,229)->(81,163,204)->(44,133,178)->(15,107,153)->(229,255,178)->(195,229,126)->(163,204,81)->(133,178,44)->(107,153,15)->(255,216,178)->(229,177,126)->(204,142,81)->(178,111,44)->(153,84,15)->(255,178,178)->(229,126,126)->(204,81,81)->(178,44,44)->(153,15,15)' ; endif
      if( coltemp = 'gebco'   ) ; coltemp = '(18,10,58)->(23,49,110)->(19,89,140)->(26,103,164)->(30,114,178)->(29,139,196)->(26,165,210)->(27,184,223)->(26,204,235)->(26,216,241)->(38,223,241)->(49,229,235)->(104,242,233)->(160,255,229)->(195,209,80)->(225,224,102)->(223,196,91)->(210,178,81)->(189,150,46)->(163,127,46)->(153,118,43)->(142,109,38)->(134,103,36)->(116,88,29)' ; endif
      if( coltemp = 'topo'    ) ; coltemp = '(40,54,154)->(0,201,50)->(30,211,104)->(94,224,116)->(162,235,130)->(223,248,146)->(246,229,149)->(200,178,118)->(162,126,94)->(143,97,84)->(162,125,116)->(178,150,139)->(199,176,170)->(219,205,202)->(236,228,226)->(255,20,147)' ; endif
      if( coltemp = 'revgrainbow' ) ; coltemp = '(240,0,130)->(250,60,60)->(240,130,40)->(230,175,45)->(230,220,50)->(160,230,50)->(0,220,0)->(0,210,140)->(0,200,200)->(0,160,255)->(30,60,255)->(110,0,220)->(160,0,200)' ; endif
      if( coltemp = 'g2m' ) ; coltemp = '(80,0,80)->(134,0,134)->(187,0,187)->(241,0,241)->(255,80,255)->(255,134,255)->(255,187,255)->(255,241,255)->(255,255,255)->(187,255,187)->(134,255,134)->(80,255,80)->(0,241,0)->(0,187,0)->(0,134,0)->(0,80,0)' ; endif
      if( coltemp = 'cbr' ) ; coltemp =  '(255,237,111)->(204,235,197)->(188,128,189)->(217,217,217)->(252,205,229)->(179,222,105)->(253,180,98)->(128,177,211)->(251,128,114)->(190,186,218)->(255,255,179)->(141,211,199)' ; endif
      if( coltemp = 'precp_diff' ) ; coltemp = '(182,106,40)->(205,133,63)->(225,165,100)->(245,205,132)->(245,224,158)->(255,245,186)->(255,255,255)->(205,255,205)->(153,240,178)->( 83,189,159)->(110,170,200)->(5,112,176)->(2, 56, 88)' ; endif
