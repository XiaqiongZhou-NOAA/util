...
**2) ocn_monmean_ens.sh**: calculate monthly mean based on $VARLIST. It use CDO to select variables from netcdf files (both atmos and ocean history), interpolate and get monthly mean. 
